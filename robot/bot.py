...
DEVELOPER_USERNAME = os.getenv('DEVELOPER_USERNAME', 'semsepiol')
...
def prompt_join_channels(chat_id):
    ...
    for idx, channel in enumerate(REQUIRED_CHANNELS, 1):
        ...
        try:
            ...
            url = f"https://t.me/OYtltNCFV3czOTFl" # Fallback to developer
...
def send_welcome_dashboard(chat_id, message_id=None):
    ...
    markup = types.InlineKeyboardMarkup(row_width=2)
    btn_dev = types.InlineKeyboardButton("👨‍💻 Developer Contact", url=f"https://t.me/{semsepiol}")
